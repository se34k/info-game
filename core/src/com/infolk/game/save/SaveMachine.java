...
public class SaveMachine {
    ...
    // Init VOR speichern/laden aufrufen, gibt true zur�ck, wenn vollst�ndig
    // initialisiert
    ...
    // L�dt einen Wert mit einem Namen aus dem JSONObject
    ...
    // L�dt die Daten aus der Savefile ins JSONObject
